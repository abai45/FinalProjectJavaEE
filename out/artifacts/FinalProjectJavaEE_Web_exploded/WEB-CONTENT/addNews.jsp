    ...
    <div class="mainContent">
        <form action="/addNews" method="post">
            <div class="popup__content">
                <div class="popup__title">Добавление новости</div>
                <div class="popup__text">
                    Заголовок:
                </div>
                <input type="text" class="popup__inputTitle" placeholder="Заголовок" name="title">
                <div class="popup__text">
                    Контент:
                </div>
                <textarea type="text" class="popup__inputArea" placeholder="Контент" name="content"></textarea>
                <div class="popup__text">
                    Категория:
                </div>
